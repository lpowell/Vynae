param($ID, $Name, [switch]$Hash, [switch]$Trace, [switch]$NetOnly, [switch]$help, [switch]$AlertOnly, [switch]$NoPath, $ParentID, $NetStatus, $Output)
# Parameters accepted
...
if(-Not $Trace -and -Not $Hash -And -Not $Help){
    ProcessInformation  
}
if($Output){
    stop-transcript
